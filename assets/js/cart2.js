...
function ready() {
    ...
    // thêm giỏ hàng
    var addCart = document.getElementsByClassName('move-to-shopee');
...
function addCartClicked(e) {
    ...
    var title = document.getElementsByClassName('title-product')[0].innerText;
    console.log(title);
    var priceAll = document.getElementsByClassName('data-price-v1')[0].innerText;
    var imgAll = document.getElementsByClassName('img-big-products')[0].src;
    console.log(imgAll);
